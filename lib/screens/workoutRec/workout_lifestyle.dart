...
class WorkoutLifestyleScreen extends StatefulWidget {
  const WorkoutLifestyleScreen({Key? key}) : super(key: key);

  @override
  _WorkoutLifestyleScreenState createState() => _WorkoutLifestyleScreenState();
}

class _WorkoutLifestyleScreenState extends State<WorkoutLifestyleScreen> {
  @override
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text('Give 2 example workout lifestyles here'),
              InkWell(
                onTap: () {},
